    ...
    return Scaffold(
      ...
      bottomNavigationBar: Material(
        ...
        child: TabBar(
          ...
          Tab(icon:Icon(Icons.navigation,color: Colors.black,size: 16,)),
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              Text("Daisy",style: TextStyle(fontFamily: "Montserrat",fontWeight:FontWeight.bold,fontSize: 12),),
                              SizedBox(height: 5,),
                              Text("34 mins ago",style: TextStyle(fontFamily: "Montserrat",fontSize: 10,color: Colors.grey),),
                            ],
                          ),
      ...
      return Column(
        children: <Widget>[
          ...
          Container(
            ...
            child: Center(child: Text("Follow",style: TextStyle(fontFamily: "Montserrat",color: Colors.white),)),
          )
        ],
      );
  }
